...
## 🔒 Security & Legal
- **[LEGAL.md](LEGAL.md)**: Critical disclaimer and terms of authorized use.
- **[SECURITY.md](SECURITY.md)**: Vulnerability disclosure policy and safety best practices.

---

## 🤝 Community & Maintenance
- **[CONTRIBUTING.md](CONTRIBUTING.md)**: How to help improve the framework.
- **[CODE_OF_CONDUCT.md](CODE_OF_CONDUCT.md)**: Participant expectations and pledge.
- **[MAINTENANCE.md](MAINTENANCE.md)**: Release process and project lifecycle management.
